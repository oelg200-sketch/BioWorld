		...
		public class Main {
		    ...
		    static void agregarPlantas(Bioma.BiomaTipo bioma) {
		        ...
		        while (agregarMas) {
		            ...
		            agregarMas = scanner.next().equalsIgnoreCase("s");
		        }
		    }
		    ...
		    static void mostrarEstadoMundo(int hora) {
		        ...
		        System.out.printf ("║  Hora: %-42s║%n", hora + "h  |  " + ecosistema.getBioma() + "  |  " + ecosistema.getTemperatura() + "°C");
		        System.out.println("╠══════════════════════════════════════════════════╣");
		    ...
		    static void mostrarMenuTurno(int hora) {
		        ...
		        switch (op) {
		            ...
		            case 5:
		                ...
		                System.exit(0);
		            default:
		                break; // avanzar horas (caso 1 o default)
		        }
		    }
		    ...
		    static int preguntarHorasASaltar() {
		        ...
		        if (op == 1) {
		            ...
		            // 1 hora = 1 minuto real (simulado con espera breve)
